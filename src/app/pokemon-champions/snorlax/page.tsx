...
export default async function SnorlaxPage() {
  const [pokemon, currentMeta, history, reference] = await Promise.all([
    getChampionsPokemon("snorlax", "Doubles"),
    getCurrentChampionsMeta("snorlax", "Doubles"),
    getChampionsMetaHistory("snorlax", "Doubles", 7),
    getPokemonReference("snorlax"),
  ]);
